...
ALTER TABLE categories ADD FOREIGN KEY (parent_id) REFERENCES categories (id) ON UPDATE CASCADE  ON DELETE CASCADE;

ALTER TABLE favorites ADD FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE addresses ADD FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE categories_attributes ADD FOREIGN KEY (categories_id) REFERENCES categories (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE categories_attributes ADD FOREIGN KEY (attributes_id) REFERENCES attributes (id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE products_attribute_value ADD FOREIGN KEY (products_id) REFERENCES products (id) ON DELETE CASCADE ON UPDATE CASCADE ;

ALTER TABLE products_attribute_value ADD FOREIGN KEY (attribute_value_id) REFERENCES attribute_value (id) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE attribute_value ADD FOREIGN KEY (attribute_id) REFERENCES attributes (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE orders ADD FOREIGN KEY (address_id) REFERENCES addresses (id) ON DELETE SET NULL  ON UPDATE  CASCADE;
